  ...
  return (
    <MarketingSection>
      ...
      <div className="relative mx-auto mt-12 max-w-4xl">
        <div
          aria-hidden
          className="absolute -inset-x-8 -inset-y-6 -z-10 rounded-[2.5rem] bg-primary/10 blur-3xl"
        />
        <div className="overflow-hidden rounded-3xl border border-border bg-card/90 shadow-2xl shadow-black/10 backdrop-blur-xl dark:shadow-black/40">
