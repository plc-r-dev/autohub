...
type ServiceStoreBookingCardProps = {
  startingPrice: string;
};

export function ServiceStoreBookingCard({ startingPrice }: ServiceStoreBookingCardProps) {
  return (
...
export function ServiceStoreRatingBadge() {
  return (
