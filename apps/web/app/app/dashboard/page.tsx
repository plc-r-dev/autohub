...
export default async function ServiceStoreDashboardPage() {
  ...
  return (
    <PageShell
      ...
      nav={serviceStoreNav}
      actions={
        <ServiceStoreButtonLink href="/app/bookings/new">Walk-in booking</ServiceStoreButtonLink>
      }
    >
      ...
      {readiness && readiness.status !== "READY" ? (
        <div className="space-y-3">
          ...
          <p className="text-sm text-[#5b6b7a]">
            <Link href="/app/readiness" className="font-semibold text-[#0F9B76] hover:underline">
