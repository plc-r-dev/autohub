      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        <ServiceStoreCard className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <ServiceStoreButtonLink href="/service-store/members">Manage members</ServiceStoreButtonLink>
            <Link href="/service-store/setup/complete" className="text-sm font-semibold text-[#0F9B76] hover:underline">
