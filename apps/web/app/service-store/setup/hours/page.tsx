      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        <ServiceStoreCard className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <ServiceStoreButtonLink href={`/service-store/branches/${branchId}/hours`}>
              Edit operating hours
            </ServiceStoreButtonLink>
            <Link href="/service-store/setup/payment" className="text-sm font-semibold text-[#0F9B76] hover:underline">
              Continue to payment
            </Link>
          </div>
        </ServiceStoreCard>
