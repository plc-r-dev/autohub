    ...
    notificationTarget = await prisma.$transaction(async (tx) => {
      const request = await tx.serviceStoreOnboardingRequest.findUnique({
        ...
        select: {
          ...
          citizenIdFileSize: true,
          citizenIdMimeType: true,
      ...
      const serviceStore = await tx.serviceStore.create({
        data: {
          ...
          citizenIdFileSize: request.citizenIdFileSize,
          citizenIdMimeType: request.citizenIdMimeType,
          companyDocumentKey: request.companyDocumentKey,
          companyDocumentUrl: request.companyDocumentUrl,
          companyDocumentFileName: request.companyDocumentFileName,
          companyDocumentFileSize: request.companyDocumentFileSize,
          companyDocumentMimeType: request.companyDocumentMimeType,
        },
      });
