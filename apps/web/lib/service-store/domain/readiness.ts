...
export function evaluateServiceStoreReadiness(input: ReadinessInput): ServiceStoreReadiness {
  const items: ReadinessCheckItem[] = [
    ...
    },
    {
      ...
      actionHref: "/service-store/members",
    },
    {
      ...
      actionHref: "/service-store/branches/new",
    },
    {
      ...
      actionHref: "/service-store/branches",
    },
    {
      id: "hours_configured",
      label: "Operating hours",
      description: "Configure opening hours for branches that offer services.",
    ...
    },
    {
      ...
      actionHref: "/service-store/profile",
    },
    {
      ...
      actionHref: "/service-store/setup/payment",
    },
  ];
